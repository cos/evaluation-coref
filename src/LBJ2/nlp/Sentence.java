...
public class Sentence extends LinkedChild
{
  ...
  {
    "museum", "travel", "aero", "arpa", "coop", "info", "jobs", "name", "biz",
    "com", "edu", "gov", "int", "mil", "net", "org", "pro", "ac", "ad", "ae",
    "af", "ag", "ai", "al", "am", "an", "ao", "aq", "ar", "as", "at", "au",
    "aw", "az", "ba", "bb", "bd", "be", "bf", "bg", "bh", "bi", "bj", "bm",
    "bn", "bo", "br", "bs", "bt", "bv", "bw", "by", "bz", "ca", "cc", "cd",
    ...
    "jp", "ke", "kg", "kh", "ki", "km", "kn", "kr", "kw", "ky", "kz", "la",
    ...
    "ro", "ru", "rw", "sa", "sb", "sc", "sd", "se", "sg", "sh", "si", "sj",
  ...
  /**
    ...
    * @return       <code>true</code> if and only if the specified symbol
    *               appears to be part of a URL.
   **/
  private boolean partOfURL(int index)
  {
    ...
    String pattern = "(?i)(" + protocols[0];
    for (int i = 1; i < protocols.length; ++i) pattern += "|" + protocols[i];
    pattern += ")://\\S+|[a-zA-Z0-9][a-zA-Z0-9-]*\\.(" + topLevelDomains[0];
    for (int i = 0; i < topLevelDomains.length; ++i)
      pattern += "|" + topLevelDomains[i];
    pattern += ")(/\\S+)?";
