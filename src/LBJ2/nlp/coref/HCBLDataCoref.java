 ...
 **/
public class HCBLDataCoref extends Classifier
{
  ...
  /**
    ...
    * document belongs to.
   **/
  private static String[] clusterNames;


  /** Constructor. */
  public HCBLDataCoref() { super("HCBLDataCoref"); }
  ...
  public String discreteValue(Object example)
  {
    ...
    {
      clusterNames = new String[d.totalMentions()];
      int nextEntityID = 0;
      ...
      for (int i = 0; i < d.sentences(); ++i)
        for (int j = 0; j < d.mentionsInSentence(i); ++j)
        {
          ...
          if (best == null)
            clusterNames[m.getIndexInDocument()] = "e" + nextEntityID++;
          else
            clusterNames[m.getIndexInDocument()] =
              clusterNames[best.getIndexInDocument()];
        }
    }

    return "" + clusterNames[pair[0].getIndexInDocument()]
                .equals(clusterNames[pair[1].getIndexInDocument()]);
  }
  ...
  /**
    * Two <code>HCBLDataCoref</code> classifiers are equivalent when their
   ...
   **/
  public boolean equals(Object o) { return o instanceof HCBLDataCoref; }
}
