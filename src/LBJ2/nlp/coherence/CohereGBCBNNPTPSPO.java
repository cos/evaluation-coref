...
public class CohereGBCBNNPTPSPO extends SparseAveragedPerceptron
{
  public static boolean isTraining = true;
  private static java.net.URL lcFilePath = CohereGBCBNNPTPSPO.class.getResource("CohereGBCBNNPTPSPO.lc");
  private static CohereGBCBNNPTPSPO instance = new CohereGBCBNNPTPSPO(false);
  public static CohereGBCBNNPTPSPO getInstance()
  {
    return instance;
  }
  ...
  public void save()
  {
    System.err.println("CohereGBCBNNPTPSPO.save() was called while its source code is at an intermediate state.  Re-run the LBJ compiler.");
    System.exit(1);
  }

  public static Parser getParser() { return new DocumentPairParser(new ACE2004DocumentParser("data" + File.separatorChar + "HLT2007.train"), new PrePredictedDocumentParser("data" + File.separatorChar + "data" + File.separatorChar + "ace_tides_multling_train" + File.separatorChar + "NoNonProToPro", "data" + File.separatorChar + "HLT2007.train")); }
  ...
  public CohereGBCBNNPTPSPO()
  {
    super("LBJ2.nlp.coherence.CohereGBCBNNPTPSPO");
    isClone = true;
  }

  private CohereGBCBNNPTPSPO(boolean b)
  {
    super(.1, 0, 4);
    containingPackage = "LBJ2.nlp.coherence";
    name = "CohereGBCBNNPTPSPO";
    setLabeler(new CoherenceLabel());
    setExtractor(new cohere$CohereGBCBNNPTPSPO$1());
    isClone = false;
  }
  ...
  public void learn(Object example)
  {
    ...
    if (!(example instanceof Document[]))
    {
      ...
      else
      {
        ...
        System.err.println("Classifier 'CohereGBCBNNPTPSPO(Document[])' defined on line 75 of cohere.lbj received '" + type + "' as input.");
...
__classify:
    {
      if (__example == CohereGBCBNNPTPSPO.exampleCache.get()) break __classify;
      CohereGBCBNNPTPSPO.exampleCache.set(__example);

      CohereGBCBNNPTPSPO.cache.set(super.classify(__example));
    }

    if (__saveExtractor != this.extractor) setExtractor(__saveExtractor);
    return (FeatureVector) CohereGBCBNNPTPSPO.cache.get();
  }
  ...
  public int hashCode() { return "CohereGBCBNNPTPSPO".hashCode(); }
  public boolean equals(Object o) { return o instanceof CohereGBCBNNPTPSPO; }
