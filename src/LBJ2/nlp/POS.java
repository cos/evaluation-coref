...
public class POS implements Serializable
{
  ...
  public static final String[] names =
  {
    ...
    "proper plural noun", "plural noun", "predeterminer", "possesive ending",
    "personal pronoun", "possesive pronoun", "adverb", "comparative adverb",
    "superlative adverb", "particle", "symbol", "to", "interjection",
    "base form verb", "verb past tense", "verb gerund / present participle",
    "verb past participle", "verb non 3rd ps. sing. present",
    "verb 3rd ps.  sing.  present", "wh-determiner", "wh-pronoun",
    "possesive wh-pronoun", "wh-adverb"
  };
