...
public class Forms extends Classifier
{
  ...
  public Forms() { super("LBJ2.nlp.Forms"); }
  ...
  public FeatureVector[] classify(Object[] examples)
  {
    for (int i = 0; i < examples.length; ++i)
      ...
      {
        System.err.println("Classifier 'Forms(Word)' defined on line 20 of CommonFeatures.lbj received '" + examples[i].getClass().getName() + "' as input.");
        new Exception().printStackTrace();
        System.exit(1);
      }
