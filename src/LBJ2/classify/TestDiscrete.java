...
public class TestDiscrete
{
  ...
  /**
    * Tests the given discrete classifier against the given oracle using the
    * given parser to provide the labeled testing data.
    *
    ...
    *                   messages.
    * @return           The same <code>TestDiscrete</code> object passed in
    *                   the first argument, after being filled with
    *                   statistics.
   **/
  ...
  public void printPerformance(PrintStream out)
  {
    ...
    String[] result =
      TableFormat.tableFormat(columnLabels, rowLabels, table,
