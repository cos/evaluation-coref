...
public class TableFormat
{
  ...
  /**
    ...
    * <code>data</code> set to <code>null</code> will become a row of dashes
    * in the output.  Any entry in any row of <code>data</code> set to
    * <code>null</code> will become a single dash in the output.  All non-null
    * entries will be rounded to three significant digits after the decimal
    * place.
    *
