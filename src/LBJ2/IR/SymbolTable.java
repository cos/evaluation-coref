...
public class SymbolTable
{
  /**
    ...
    * @return           An object representing the file or <code>null</code>
  ...
  /**
    ...
    *           <code>null</code> if no type was previously associated with
    *           it.
   **/
  ...
  /**
    ...
    *             it.
   **/
  public Type put(Name name, Type type) { return put("" + name, type); }
  ...
  /**
    ...
    * @return     The type associated with the given name or <code>null</code>
    *             if no type information could be found.
   **/
  public Type get(ClassifierName name) { return get("" + name.referent); }
  ...
  /**
    ...
    *             if no type information could be found.
   **/
  public Type get(Name name) { return get("" + name); }
  ...
  public Class classForName(Name name)
  {
    ...
    prefixes.add("");
    if (!sourcePackage.equals("")) prefixes.add(sourcePackage + ".");
  ...
  /**
    ...
    *
    * @param key  The name.
    * @return     <code>true</code> iff <code>key</code> is already a key in
    *             this table or any of its parents.
   **/
