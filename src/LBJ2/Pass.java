...
public abstract class Pass
{
  ...
  public static void reportError(int line, String message)
  {
    ...
    errorsAndWarnings.put(new Integer(line), error);
    fatalError = true;
  }
  ...
  {
    if (Main.clean || Main.warningsDisabled) return;
    ...
    errorsAndWarnings.put(new Integer(line), warning);
  }
  ...
  public static void printErrorsAndWarnings()
  {
    ...
    for (int i = 0; i < entries.length; ++i)
      System.err.print(entries[i].getValue());
