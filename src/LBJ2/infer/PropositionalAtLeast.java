...
public class PropositionalAtLeast extends PropositionalNAryConstraint
{
  ...
  /**
    ...
    * @return   <code>true</code> iff the given constraint is contained in
    *           this constraint.
   **/
  ...
  {
    int i;
    for (i = 1; i < I.length && I[i] - I[i - 1] == 1; ++i);
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given implication.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given conjunction.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given disjunction.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given negation.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given variable.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given constant.
   **/
