...
public class PropositionalDisjunction extends PropositionalNAryConstraint
{
  ...
  /**
    ...
    * @return   <code>true</code> iff <code>I</code> contains valid indexes
    *           for a new combination; <code>false</code> iff if there are no
    *           more combinations.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more general than the given constraint.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given implication.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given conjunction.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given disjunction.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given negation.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given variable.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> if a topological analysis determined that
    *           this constraint is more specific than the given constant.
   **/
  ...
  /**
    ...
    * @return       A new representation of this n-ary constraint with the
    *               specified terms removed.
   **/
  ...
  /**
    ...
    * @return   <code>true</code> iff this disjunction contains all of the
    *           terms that the given disjunction contains.
   **/
