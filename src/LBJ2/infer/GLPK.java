...
public class GLPK extends Inference
{
  ...
  /** Debugging variable. */
  private boolean PRINT_ILP = false;
  ...
  /**
    * This constructor is invoked by simply supplying any integer argument;
    * the argument is ignored, and debugging output is enabled.
    *
    * @param i  Anything.
   **/
  public GLPK(int i) { this(null, 0); }
  ...
  protected int createNewVariable(String d)
  {
    ...
    if (PRINT_ILP) System.out.println(result + ": " + d);
    return result;
  }
